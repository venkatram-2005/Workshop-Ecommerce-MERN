...
export default function Home() {
  ...
  async function fetchProducts() {
    await axios.get("https://workshop-ecommerce-mern.onrender.com/api/product")
      .then((res) => {
        console.log(res)
  ...
  async function addCart(productId) {
    ...
    try {
      await axios.post("https://workshop-ecommerce-mern.onrender.com/api/cart/add", { productId }, {
